...
/* ---------------------- search.jsp start --------------------- */
{
    String doingFeedbackStr = request.getParameter("doFeedback");
    boolean doingFeedback = "true".equalsIgnoreCase(doingFeedbackStr);
    if (doingFeedback == true) {
    	String [] relevant = request.getParameterValues("relavant");
    }
...
%>
    ...
    if (searchHelper.errorMsg != null) {
        ...
        <form id ="serachForm" action="feedback.jsp" method="post">
        <table>
        <%
        ...
        %>
    </div>  <input type="checkbox" name="doFeedback" value="true">Perform Feedback</input>&nbsp;
